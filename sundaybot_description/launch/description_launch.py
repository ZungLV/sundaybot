# Launch sundaybot URDF file using Rviz
...
def generate_launch_description():
    ...
    pkg_path= FindPackageShare(package='sundaybot_description').find('sundaybot_description')
    rviz_config_path = os.path.join(pkg_path, 'rviz/description.rviz')
    urdf_model_path = os.path.join(pkg_path, 'urdf/sundaybot.urdf.xacro')
