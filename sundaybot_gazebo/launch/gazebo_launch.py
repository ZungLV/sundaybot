# Launches the sundaybot in Gazebo to be controlled using a joystick. There are a number of launch arguments that can be toggled.
...
def generate_launch_description():
    ...
    pkg_path = FindPackageShare(package="sundaybot_gazebo").find("sundaybot_gazebo")
    pkg_description = FindPackageShare(package="sundaybot_description").find(
        "sundaybot_description"
    )
    pkg_teleop = FindPackageShare(package="sundaybot_teleop").find("sundaybot_teleop")
    pkg_gazebo_ros = FindPackageShare(package="gazebo_ros").find("gazebo_ros")
    pkg_navigation = FindPackageShare(package="sundaybot_navigation").find(
        "sundaybot_navigation"
    )
    ...
    start_spawner_cmd = Node(
        ...
        output="screen",
        arguments=["-topic", "robot_description", "-entity", "sundaybot"],
    )
